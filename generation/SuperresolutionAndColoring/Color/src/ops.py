...
#Erstellt einen Con2D-Transpose Block
...
#Vergleicht die Bilder, in dem die einzelnen Pixel verglichen werden
...
#Konvertiert den Farbraum RGB zu LAB
def rgb_to_lab(srgb):
...
#Konvertiert den Farbraum LAB zu RGB
def lab_to_rgb(lab):
