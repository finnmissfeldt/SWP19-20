...
image_shape = (32,32,3) #Bildformat und Farbkanäle -> 32x32 Pixel, 3 Farbkanäle

#Testet das Modell mit hochauflösenden Bildern
...
#Testet das Modell mit geringauflösenden Bildern
