...
downscale_factor = 4 #Skalierungsfakor

image_shape = (128,128,3) #Bildformat

# Erstellt das Netz aus dem Diskriminator und dem Generator
...
# für alle Parameter sind Standardwerte gesetzt
# weitere Informationen: $python train.py -h
